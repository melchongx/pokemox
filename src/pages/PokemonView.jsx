  ...
  return (
    <>
      { fetchError.pokemon ? (<div>Error fetching Pokémon data</div>) : (
        <>
          { pokemon && (
            <PokemonNav currentId={species.id} isBaseForm={pokemon.is_default} />
          )}

          <section className="flex flex-row justify-center w-full gap-8">
            <div className="">
              <img className="bg-[#D1C8C1] w-[400px] rounded-md p-5 mb-8" src={pokemon.sprites?.other["official-artwork"].front_default} alt={pokemon.name} />
